...
public class RemoveDuplicatesFromSortedListII82Test {
    ...
    public void test() {
        ...
        RemoveDuplicatesFromSortedListII82.ListNode node1 = new RemoveDuplicatesFromSortedListII82().new ListNode(1);
        RemoveDuplicatesFromSortedListII82.ListNode node2 = new RemoveDuplicatesFromSortedListII82().new ListNode(3);
        node.next = node1;
        node1.next = node2;
        node2.next = null;
