...
public class MinimumWindowSubstringTest {
  ...
  public void test() {
    ...
    Assert.assertEquals(true, solution.check(solution.calc_freq("ABB"), solution.calc_freq("AB")));

    Assert.assertEquals(false, solution.check(solution.calc_freq("AB"), solution.calc_freq("ABB")));
